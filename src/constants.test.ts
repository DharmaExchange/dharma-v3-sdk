...
import { bytecode } from 'dharma-v3-core/artifacts/contracts/UniswapV3Pool.sol/UniswapV3Pool.json'
import { bytecode as SwapRouterBytecode } from 'dharma-v3-periphery-optimism/artifacts-ovm/contracts/SwapRouter.sol/SwapRouter.json'
